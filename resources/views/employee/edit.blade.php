        ...
        <div class="row justify-content-center">
            <div class="col-8 bg-white border shadow p-2 rounded">
                <div class="text-center">
                    <h1 class="fw-bold">Editar Empleado {{ $employee->id }}</h1>
                </div>
                <form action="{{ route('empleados.update', $employee->id) }}" method="POST">
                    ...
                    <div class="d-grid gap-3">
                        <div class="">
                            ...
                            <input type="text" class="form-control @error('id')is-invalid @enderror" name="id" id="id" value="{{ $employee->id }}" >
                            @error('id')
                        ...
                        <div class="">
                            ...
                            <input type="date" class="form-control @error('birth')is-invalid @enderror" id="birth" name="birth" value="{{ $employee->birth }}" >
                            @error('birth')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="">
                            ...
                            <input type="text" class="form-control @error('number_phone')is-invalid @enderror" id="number_phone" name="number_phone" value="{{ $employee->number_phone }}" >
                            @error('number_phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <button type="submit" class="btn btn-primary col-2 mx-auto">Actualizar</button>
                    </div>
